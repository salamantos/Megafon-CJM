...
var appData = {"states":[{"name":"Узнаёт","variants":[]},{"name":"Подключает","variants":[]},{"name":"Использует","variants":[[{"title":"Получает SMS с подтверждением","icon":"far fa-comment-alt","info":"SMS с информацией о платной опции приходит через X дней после подключения","smsInfo":"","danger":"","cnm":""}]]},{"name":"Реакция на изменения","variants":[[{"title":"Оставляет платную услугу","icon":"far fa-money-bill-alt","info":"","smsInfo":"SMS с подтверждением окончания акции","danger":"","cnm":"Спасибо за то, что остаись с нами и решили продолжить пользоваться услугой"}],[{"title":"Звонит в КЦ","icon":"fas fa-phone","info":"","smsInfo":"","danger":"Негативные реакции, если абонент забыл отключить опцию до окончания акции","cnm":""}],[{"title":"Отключает пакет","icon":"fas fa-ban","info":"Отключение возможно через Личный кабинет, контактный центр, по команде","smsInfo":"Сказать, что будем рады видеть еще","danger":"","cnm":"Нам жаль, что вы решили отключить нашу услугу. Мы будем работать над ее улучшением и надеемся, что вы когда-нибудь подключите ее снова"}],[{"title":"Уезжает в роуминг","icon":"fas fa-phone","info":"Добро пожаловать в страну!","smsInfo":"","danger":"Цена услуги повышается. Клиент может быть недоволен.","cnm":"Пакет был отключен. Подробная информация в личном кабинете"}]]},{"name":"Отключает","variants":[]}],"name":""};
